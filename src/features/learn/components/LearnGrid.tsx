...
// Lazy-load LessonModal to reduce bundle size and startup overhead
const LessonModal = dynamic(() => import('./LessonModal'), {
  ssr: false,
});
...
export function LearnGrid() {
  ...
  const handleLessonComplete = (xpEarned: number, lessonId: string) => {
